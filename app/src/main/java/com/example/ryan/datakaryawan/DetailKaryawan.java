...
public class DetailKaryawan extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(DetailKaryawan.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(DetailKaryawan.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(DetailKaryawan.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    private void deleteEmployee(){
        class DeleteEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(DetailKaryawan.this, "Updating...", "Tunggu...", false, false);
            }
    ...
    private void confirmDeleteEmployee(){
        ...
        alertDialogBuilder.setMessage("Apakah Kamu Yakin Ingin Menghapus Karyawan ini?");
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(DetailKaryawan.this,SemuaKaryawan.class));
                    }
                });
